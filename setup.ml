...
(* OASIS_START *)
(* DO NOT EDIT (digest: 71c9d116a4e14452590f5a6ec4db5fd1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/akabe/ppx_bigarray";
          synopsis =
            "A PPX extension for providing big array literals in OCaml";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_bigarray"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ppx_bigarray";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_bigarray_ex.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/akabe/ppx_bigarray.git";
                      src_repo_browser =
                        Some "https://github.com/akabe/ppx_bigarray";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\152k\152\204T\207\219\136\128\159\175tz\148D\127";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
